package com.syncup.app.feature.auth.signin
...
fun SignInScreen(navController: NavHostController) {
    ...
    val viewModel: SignInViewModel = remember { SignInViewModel() }
    ...
    LaunchedEffect(key1 = uiState.value) {
        when (uiState.value) {
            is SignInState.Success -> {
                // --- LOGIN CRASH FIX ---
                // "home" ki jagah "main" par navigate karenge aur purane screens hata denge
